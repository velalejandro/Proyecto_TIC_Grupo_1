              ...
              <div className="col-12">
                <form className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <input className="form-control" type="text" name="inputProductCode" />
                  </div>
                  <div className="col-md-6">
                    <label htmlFor="cantidadProduct" className="form-label">Valor Unitario:</label>
                    <input type="number" className="form-control" />
                  </div>
                  <div className="col-md-6">
                    <label htmlFor="cantidadProduct" className="form-label">Estado:</label>
